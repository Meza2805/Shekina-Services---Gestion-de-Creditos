...
namespace Entidades
{
    public class Persona_BaseEntity
    {
        ...
        public DateTimeOffset? Fecha_Registro { get; set; }// datetimeoffset, con default GETDATE(), puede ser NULL
        public int? Id_Usuario_Modifica { get; set; }       // int, NULL
        public DateTimeOffset? Fecha_Modifica { get; set; }// datetimeoffset, con default GETDATE(), puede ser NULL
